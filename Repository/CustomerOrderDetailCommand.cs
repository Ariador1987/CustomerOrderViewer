...
{
    public class CustomerOrderDetailCommand
    {
        ...
        public IList<CustomerOrderDetailModel> GetList()
        {
            ...
            using (SqlConnection connection = new SqlConnection(_connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand(@"SELECT CustomerOrderId, 
                                                                    CustomerId, 
                                                                    ItemId, 
                                                                    FirstName, 
                                                                    LastName, 
                    ...
                    using (SqlDataReader reader = command.ExecuteReader())
                    {
                        if (reader.HasRows)
                        {
                            while (reader.Read())
                            {
                                ...
                                // sad nakon što smo kreiramli model moramo ga dodati u listu, inače će lista biti prazna.
